...
description: How to use the AgentBreeder org-wide registry.
---
...
| **Model** | Registered LLM with provider, pricing, and capabilities | `models/claude-sonnet-4` |
...
=== "Interactive wizard"
    ...
    2. **Cloud target** — Local, AWS (ECS Fargate / App Runner), GCP (Cloud Run), Azure (Container Apps), Kubernetes, or Claude-managed
