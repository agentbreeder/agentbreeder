...
description: Choose your migration path to AgentBreeder.
---
...
|----------------|---------------|------------|-------|
| **LangGraph** | ~15 minutes | Easy | [LangGraph guide](/docs/migrations/from-langgraph) |
| **CrewAI** | ~20 minutes | Easy | [CrewAI guide](/docs/migrations/from-crewai) |
| **OpenAI Agents SDK** | ~15 minutes | Easy | [OpenAI Agents guide](/docs/migrations/from-openai-agents) |
| **Microsoft AutoGen** | ~30 minutes | Moderate | [AutoGen guide](/docs/migrations/from-autogen) |
| **Custom Python agent** | ~20 minutes | Easy | [Custom guide](/docs/migrations/from-custom) |
...
Use `framework: custom`. See the [Custom migration guide](/docs/migrations/from-custom). Any Python agent that can be called via a function works.
...
1. [Migrate from LangGraph](/docs/migrations/from-langgraph)
2. [Migrate from CrewAI](/docs/migrations/from-crewai)
3. [Migrate from OpenAI Agents SDK](/docs/migrations/from-openai-agents)
4. [Migrate from Microsoft AutoGen](/docs/migrations/from-autogen)
5. [Bring Your Own Agent (Custom)](/docs/migrations/from-custom)
