...
|-------------|-------------|-----|---------------|
| **Python** | 3.11+ | CLI, API server, Python SDK | [python.org](https://www.python.org/downloads/) or `brew install python@3.11` |
| **Docker** | 24+ | `--target local` deploys and all container builds | [docs.docker.com/get-docker](https://docs.docker.com/get-docker/) |
| **Node.js + npx** | 18+ | MCP servers (most run via `npx`), TypeScript SDK | [nodejs.org](https://nodejs.org/) or `brew install node` |
| **Ollama** | any | Local model inference — only if you don't have cloud API keys | [ollama.com](https://ollama.com) |
...
<Callout type="info" title="Minimum to get started">
