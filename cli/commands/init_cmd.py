...
def _agent_yaml(name: str, framework: str, cloud: str, model: str, team: str, owner: str) -> str:
    return f"""\
# Agent Garden configuration — generated by `garden init`
# Docs: https://github.com/open-agent-garden/agent-garden
...
def invoke(input_data: dict) -> dict:
    ...
    This is the entry point that Agent Garden will call.
    """
...
{fw["icon"]} **{fw["name"]}** agent — scaffolded by Agent Garden.
...
# 5. Deploy
garden deploy agent.yaml --target {cloud}
```
...
- [Agent Garden Docs](https://github.com/open-agent-garden/agent-garden)
- [{fw["name"]} Docs](https://github.com/open-agent-garden/agent-garden#frameworks)
"""
...
def init(
    ...
    console.print(
        Panel(
            ...
            f"  [dim]$[/dim] garden validate agent.yaml\n"
            f"  [dim]$[/dim] garden deploy agent.yaml --target {cloud['key']}",
            title="Ready",
            border_style="green",
            padding=(1, 2),
        )
